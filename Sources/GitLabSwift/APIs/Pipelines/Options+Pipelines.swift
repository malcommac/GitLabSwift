...
extension APIOptions {
    ...
    public class PipelinesSearch: APIOptionsCollection {
        
        /// The ID or URL-encoded path of the project owned by the authenticated user
        @APIOption(key: "id") public var project: DataTypes.ProjectID?
        
        /// The scope of pipelines.
        @APIOption(key: "scope") public var scope: DataTypes.MilestoneScope?
        
        // The status of pipelines
        @APIOption(key: "status") public var status: DataTypes.PipelineStatus?
        
        /// How the pipeline was triggered.
        @APIOption(key: "source") public var source: DataTypes.PipelineSource?
        ...
        @APIOption(key: "yaml_errors") public var yamlErrors: Bool?
        
        /// The username of the user who triggered pipelines.
        @APIOption(key: "username") public var username: String?
        ...
        /// Order pipelines by.
        @APIOption(key: "order_by") public var order: DataTypes.PipelineOrder?
        
        /// Sort pipelines.
        @APIOption(key: "sort_by") public var sort: DataTypes.Sort?

        public init(project: DataTypes.ProjectID, _ configure: ((PipelinesSearch) -> Void)?) {
            super.init()
