...
extension APIService {
    ...
    public class Pipelines: APIService {
        ...
        /// - Returns: pipeline
        func latest(project: DataTypes.ProjectID, ref: String? = nil) async throws -> GitLabResponse<Model.Pipeline> {
            let options = APIOptionsCollection([
