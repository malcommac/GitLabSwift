...
extension APIOptions {
    ...
    public class ProjectForkSearch: APIOptionsCollection {
        
        /// The ID or URL-encoded path of the project.
        @APIOption(key: "id") public var projectID: DataTypes.ProjectID?
        
        /// Limit by archived status.
        @APIOption(key: "archived") public var archived: Bool?
        
        /// Limit by projects that the current user is a member of.
        @APIOption(key: "membership") public var membership: Bool?
        
        /// Limit by current user minimal role (`access_level`).
        @APIOption(key: "min_access_level") public var minAccessLevel: DataTypes.AccessLevel?
        
        /// Ordered of items returned by the query.
        @APIOption(key: "order_by") public var orderBy: DataTypes.ProjectOrder?
        
        /// Limit by projects explicitly owned by the current user.
        @APIOption(key: "owned") public var owned: Bool?
        ...
        @APIOption(key: "simple") public var simple: Bool?
        
        /// Return projects sorted in `asc` or `desc` order. Default is `desc`.
        @APIOption(key: "sort") public var sort: DataTypes.Sort?
        
        /// Limit by projects starred by the current user.
        @APIOption(key: "starred") public var starred: Bool?
        
        /// Include project statistics. Only available to `Reporter` or higher level role members.
        @APIOption(key: "statistics") public var statistics: Bool?
        
        /// Limit by visibility.
        @APIOption(key: "visibility") public var visibility: DataTypes.ProjectVisibility?
        
        /// Include custom attributes in response. (`administrators` only).
        @APIOption(key: "with_custom_attributes") public var includeCustomAttributes: Bool?
        
        /// Limit by enabled issues feature.
        @APIOption(key: "with_issues_enabled") public var onlyWithIssuesEnabled: Bool?
        
        /// Limit by enabled merge requests feature.
        @APIOption(key: "with_merge_requests_enabled") public var onlyWithMRsEnabled: Bool?
        
        public init(projectID: DataTypes.ProjectID, _ configure: ((ProjectForkSearch) -> Void)?) {
            super.init()
    ...
    public class ProjectFork: APIOptionsCollection {
        ...
        @APIOption(key: "mr_default_target_self") public var mrDefaultTargetSelf: Bool?
        
        /// The name assigned to the resultant project after forking.
        @APIOption(key: "name") public var name: String?
        
        /// The ID of the namespace that the project is forked to.
        @APIOption(key: "namespace_id") public var namespaceId: Int?
        
        /// The path of the namespace that the project is forked to.
        @APIOption(key: "namespace_path") public var namespacePath: String?
        ...
        public init(projectID: DataTypes.ProjectID, _ configure: ((ProjectFork) -> Void)?) {
            super.init()
            self.projectID = projectID
            configure?(self)
        }
    ...
    public class ProjectGroups: APIOptionsCollection {
        ...
        @APIOption(key: "shared_min_access_level") public var minAccessLevel: DataTypes.AccessLevel?

        /// Limit to shared groups user has access to.
        @APIOption(key: "shared_visible_only") public var visibleOnly: Bool?

        /// Skip the group IDs passed.
        @APIOption(key: "skip_groups") public var skipGroups: [Int]?
        
        /// Include projects shared with this group. Default is false.
        @APIOption(key: "with_shared") public var withShared: Bool?

        public init(projectID: DataTypes.ProjectID, _ configure: ((ProjectGroups) -> Void)?) {
            super.init()
            self.projectID = projectID
            configure?(self)
        }
    ...
    public class ProjectUsersOptions: APIOptionsCollection {
        ...
        @APIOption(key: "skip_users") public var skipUsers: [Int]?

        public init(projectID: DataTypes.ProjectID, _ configure: ((ProjectUsersOptions) -> Void)?) {
            super.init()
            self.projectID = projectID
            configure?(self)
        }
    ...
    // MARK: - SearchSingleProject
    
    public class SearchSingleProject: APIOptionsCollection {
        
        /// The ID or URL-encoded path of the project.
        @APIOption(key: "id") public var projectID: DataTypes.ProjectID?

        /// Include project license data.
        @APIOption(key: "license") public var license: Bool?
        
        /// Include project statistics. Only available to Reporter or higher level role members.
        @APIOption(key: "statistics") public var statistics: Bool?

        /// Include custom attributes in response. (administrators only)
        @APIOption(key: "with_custom_attributes") public var withCustomAttributes: Bool?
     
        public init(projectID: DataTypes.ProjectID, _ configure: ((SearchSingleProject) -> Void)?) {
            super.init()
            self.projectID = projectID
            configure?(self)
        }
    ...
    // MARK: - SearchUserProjects
    
    public class SearchUserProjects: APIOptionsCollection {
        
        /// The ID or username of the user.
        @APIOption(key: "user_id") public var userId: Int?
        
        /// Limit by archived status.
        @APIOption(key: "archived") public var archived: Bool?
        
        /// Limit results to projects with IDs greater than the specified ID.
        @APIOption(key: "id_after") public var idAfter: Bool?

        /// Limit results to projects with IDs less than the specified ID.
        @APIOption(key: "id_before") public var idBefore: Bool?

        /// Limit by projects that the current user is a member of.
        @APIOption(key: "membership") public var membership: Bool?
        
        /// Limit by current user minimal role.
        @APIOption(key: "min_access_levelmbership") public var accessLevel: DataTypes.AccessLevel?
        ...
        public init(userID: Int, _ configure: ((SearchUserProjects) -> Void)?) {
            super.init()
            self.userId = userId
            configure?(self)
        }
    ...
    /// [Documentation](https://docs.gitlab.com/ee/api/projects.html).
    public class SearchProjects: APIOptionsCollection {
        ...
        @APIOption(key: "imported") public var imported: Bool?
        
        /// Limit results to projects with last activity after specified time.
        @APIOption(key: "last_activity_after") public var lastActivityAfter: Date?

        /// Limit results to projects with last activity before specified time.
        @APIOption(key: "last_activity_before") public var lastActivityBefore: Date?
        ...
        @APIOption(key: "repository_checksum_failed") public var repositoryChecksumFailed: String?
        
        /// Limit results to projects stored on repository_storage (administrators only).
        @APIOption(key: "repository_storage") public var repositoryStorage: String?

        /// Include ancestor namespaces when matching search criteria. Default is false.
        @APIOption(key: "search_namespaces") public var searchNamespaces: Bool?
        ...
        @APIOption(key: "topic") public var topic: String?

        /// Limit results to projects with the assigned topic given by the topic ID.
        @APIOption(key: "topic_id") public var topicId: Int?

        /// Limit by visibility.
        @APIOption(key: "visibility") public var visibility: DataTypes.ProjectVisibility?

        /// Limit projects where the wiki checksum calculation has failed.
        @APIOption(key: "wiki_checksum_failed") public var wikiChecksumFailed: Bool?

        /// Include custom attributes in response. (administrator only)
        @APIOption(key: "with_custom_attributes") public var withCustomAttributes: Bool?

        /// Limit by enabled issues feature.
        @APIOption(key: "with_issues_enabled") public var withIssuesEnabled: Bool?

        /// Limit by enabled merge requests feature.
        @APIOption(key: "with_merge_requests_enabled") public var withMergeRequestsEnabled: Bool?

        /// Limit by projects which use the given programming language.
        @APIOption(key: "with_programming_language") public var withProgrammingLanguage: Bool?

        public init(_ configure: ((SearchProjects) -> Void)?) {
            super.init()
            configure?(self)
        }
