...
extension APIService {
    ...
    public class GroupMilestones: APIService {
        ...
        /// - Returns: milestones.
        public func list(id: Int,
                         _ callback: ((APIOptions.GroupMilestonesSearch) -> Void)? = nil) async throws -> GitLabResponse<[Model.Milestone]> {
            let options = APIOptions.GroupMilestonesSearch(group: id, callback)
        ...
        public func get(id: Int,
                        ofGroup group: Int) async throws -> GitLabResponse<Model.Milestone> {
        ...
        public func create(title: String,
                           ...
                           due: Date? = nil,
                           start: Date? = nil,
                           inGroup group: Int) async throws -> GitLabResponse<Model.Milestone> {
            let options = APIOptionsCollection([
                APIOption(key: "id", group),
        ...
        public func issues(assignedToMilestone milestone: Int,
                           ofGroup group: Int) async throws -> GitLabResponse<[Model.Issue]> {
            let options = APIOptionsCollection([
                APIOption(key: "id", group),
                APIOption(key: "milestone_id", milestone)
            ])
        ...
        public func mergeRequests(assignedToMilestone milestone: Int,
                                  ofGroup group: Int) async throws -> GitLabResponse<[Model.MergeRequest]> {
            let options = APIOptionsCollection([
                APIOption(key: "id", group),
                APIOption(key: "milestone_id", milestone)
            ])
